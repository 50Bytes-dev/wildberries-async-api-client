...
async def get_advv1searchsupplier_products(
    subject: Optional[int] = None, api_config_override: Optional[APIConfig] = None
) -> List[Dict[str, Any]]:
    api_config = api_config_override if api_config_override else APIConfig()

    base_path = api_config.base_path
    path = f"/adv/v1/search/supplier-products"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
    ...
    query_params: Dict[str, Any] = {"subject": subject}
...
async def get_advv0active(
    id: int, subjectId: int, status: str, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()

    base_path = api_config.base_path
    path = f"/adv/v0/active"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
    ...
    query_params: Dict[str, Any] = {"id": id, "subjectId": subjectId, "status": status}
