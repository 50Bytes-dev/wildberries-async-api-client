...
async def get_apiv1questionsproductsrating(
    size: int, api_config_override: Optional[APIConfig] = None
) -> ApiV1QuestionsProductsRatingGetResponse:
    api_config = api_config_override if api_config_override else APIConfig()

    base_path = api_config.base_path
    path = f"/api/v1/questions/products/rating"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
    ...
    query_params: Dict[str, Any] = {"size": size}
    ...
    async with aiohttp.ClientSession(headers=headers) as session:
        async with session.request(
            ...
            return (
                ApiV1QuestionsProductsRatingGetResponse(**response)
                if response is not None
                else ApiV1QuestionsProductsRatingGetResponse()
            )
...
async def get_apiv1questionsreport(
    isAnswered: bool, api_config_override: Optional[APIConfig] = None
) -> ApiV1QuestionsReportGetResponse:
    api_config = api_config_override if api_config_override else APIConfig()

    base_path = api_config.base_path
    path = f"/api/v1/questions/report"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
    ...
    query_params: Dict[str, Any] = {"isAnswered": isAnswered}
    ...
    async with aiohttp.ClientSession(headers=headers) as session:
        async with session.request(
            ...
            return (
                ApiV1QuestionsReportGetResponse(**response)
                if response is not None
                else ApiV1QuestionsReportGetResponse()
            )
