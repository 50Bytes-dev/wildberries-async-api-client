...
class NmReportGroupedRequest(BaseModel):
    ...
    order_by: Optional[NmReportGroupedRequestOrderBy] = Field(default=None, alias="orderBy")
    page: StrictInt = Field(description="Страница")
    __properties: ClassVar[List[str]] = ["objectIDs", "brandNames", "tagIDs", "timezone", "period", "orderBy", "page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "period": NmReportGroupedRequestPeriod.from_dict(obj["period"]) if obj.get("period") is not None else None,
            "orderBy": NmReportGroupedRequestOrderBy.from_dict(obj["orderBy"]) if obj.get("orderBy") is not None else None,
            "page": obj.get("page")
        })
        return _obj
