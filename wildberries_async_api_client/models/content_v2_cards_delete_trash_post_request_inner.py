...
class ContentV2CardsDeleteTrashPostRequestInner(BaseModel):
    """
    ContentV2CardsDeleteTrashPostRequestInner
    """ # noqa: E501
    nm_ids: Optional[List[StrictInt]] = Field(default=None, description="Артикул WB (max. 1000)", alias="nmIDs")
