...
class ApiV1FeedbacksProductsRatingTopGet200Response(BaseModel):
    """
    ApiV1FeedbacksProductsRatingTopGet200Response
    """ # noqa: E501
    data: Optional[List[ApiV1FeedbacksProductsRatingTopGet200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ApiV1FeedbacksProductsRatingTopGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "error": obj.get("error"),
