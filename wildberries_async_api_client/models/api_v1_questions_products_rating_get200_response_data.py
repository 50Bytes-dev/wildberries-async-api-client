...
class ApiV1QuestionsProductsRatingGet200ResponseData(BaseModel):
    """
    ApiV1QuestionsProductsRatingGet200ResponseData
    """ # noqa: E501
    products: Optional[List[ApiV1QuestionsProductsRatingGet200ResponseDataProductsInner]] = Field(default=None, description="Массив структур товаров")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": [ApiV1QuestionsProductsRatingGet200ResponseDataProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
