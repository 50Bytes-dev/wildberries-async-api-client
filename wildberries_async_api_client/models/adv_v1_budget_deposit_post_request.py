...
class AdvV1BudgetDepositPostRequest(BaseModel):
    ...
    """ # noqa: E501
    sum: Optional[StrictInt] = Field(default=None, description="Сумма пополнения (min. 500 ₽)")
    type: Optional[StrictInt] = Field(default=None, description="<dl> <dt>Тип источника пополнения:</dt> <dd><code>0</code> - Счёт</dd> <dd><code>1</code> - Баланс</dd> <dd><code>3</code> - Бонусы</dd> </dl> ")
    ...
    __properties: ClassVar[List[str]] = ["sum", "type", "return"]
