...
class Chat(BaseModel):
    ...
    reply_sign: Optional[StrictStr] = Field(default=None, description="Подпись чата. Требуется при [отправке сообщения](./#/paths/~1api~1v1~1seller~1message/post) ", alias="replySign")
    ...
    __properties: ClassVar[List[str]] = ["chatID", "replySign", "clientID", "clientName"]
