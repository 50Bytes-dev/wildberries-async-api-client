...
class NmReportDetailResponseDataCardsInnerStatistics(BaseModel):
    """
    Статистика
    """ # noqa: E501
    selected_period: Optional[NmReportDetailResponseDataCardsInnerStatisticsSelectedPeriod] = Field(default=None, alias="selectedPeriod")
    previous_period: Optional[NmReportDetailResponseDataCardsInnerStatisticsPreviousPeriod] = Field(default=None, alias="previousPeriod")
    period_comparison: Optional[NmReportDetailResponseDataCardsInnerStatisticsPeriodComparison] = Field(default=None, alias="periodComparison")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "selectedPeriod": NmReportDetailResponseDataCardsInnerStatisticsSelectedPeriod.from_dict(obj["selectedPeriod"]) if obj.get("selectedPeriod") is not None else None,
            "previousPeriod": NmReportDetailResponseDataCardsInnerStatisticsPreviousPeriod.from_dict(obj["previousPeriod"]) if obj.get("previousPeriod") is not None else None,
            "periodComparison": NmReportDetailResponseDataCardsInnerStatisticsPeriodComparison.from_dict(obj["periodComparison"]) if obj.get("periodComparison") is not None else None
        })
        return _obj
