...
class ApiV3FilesOrdersExternalStickersPost200Response(BaseModel):
    """
    ApiV3FilesOrdersExternalStickersPost200Response
    """ # noqa: E501
    stickers: Optional[List[ApiV3FilesOrdersExternalStickersPost200ResponseStickersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stickers": [ApiV3FilesOrdersExternalStickersPost200ResponseStickersInner.from_dict(_item) for _item in obj["stickers"]] if obj.get("stickers") is not None else None
        })
        return _obj
