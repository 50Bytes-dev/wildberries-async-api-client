...
class AdvV1SeacatStatGet200ResponseDatesInnerCatalog(BaseModel):
    """
    Каталог
    """ # noqa: E501
    ...
    sum: Optional[StrictInt] = Field(default=None, description="Затраты, ₽.")
    __properties: ClassVar[List[str]] = ["views", "clicks", "orders", "sum"]
