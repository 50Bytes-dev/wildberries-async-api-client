...
class ApiV1ListPost200Response(BaseModel):
    """
    ApiV1ListPost200Response
    """ # noqa: E501
    data: Optional[List[ApiV1ListPost200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ApiV1ListPost200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
