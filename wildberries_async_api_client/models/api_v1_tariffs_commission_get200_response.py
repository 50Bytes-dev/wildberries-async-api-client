...
APIV1TARIFFSCOMMISSIONGET200RESPONSE_ONE_OF_SCHEMAS = ["Commission", "CommissionChina", "CommissionTurkey", "CommissionUzbekistan"]
...
class ApiV1TariffsCommissionGet200Response(BaseModel):
    ...
    actual_instance: Optional[Union[Commission, CommissionChina, CommissionTurkey, CommissionUzbekistan]] = None
    one_of_schemas: Set[str] = { "Commission", "CommissionChina", "CommissionTurkey", "CommissionUzbekistan" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ApiV1TariffsCommissionGet200Response with oneOf schemas: Commission, CommissionChina, CommissionTurkey, CommissionUzbekistan. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ApiV1TariffsCommissionGet200Response with oneOf schemas: Commission, CommissionChina, CommissionTurkey, CommissionUzbekistan. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ApiV1TariffsCommissionGet200Response with oneOf schemas: Commission, CommissionChina, CommissionTurkey, CommissionUzbekistan. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ApiV1TariffsCommissionGet200Response with oneOf schemas: Commission, CommissionChina, CommissionTurkey, CommissionUzbekistan. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Commission, CommissionChina, CommissionTurkey, CommissionUzbekistan]]:
