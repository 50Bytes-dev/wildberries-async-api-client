...
class NmReportGroupedResponseDataGroupsInnerStatisticsPreviousPeriod(BaseModel):
    """
    ...
    orders_sum_rub: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Заказали на сумму, руб.", alias="ordersSumRub")
    buyouts_count: Optional[StrictInt] = Field(default=None, description="Выкупили товаров, штук", alias="buyoutsCount")
    buyouts_sum_rub: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Выкупили на сумму, руб.", alias="buyoutsSumRub")
    ...
    avg_price_rub: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Средняя цена, руб.", alias="avgPriceRub")
    avg_orders_count_per_day: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Среднее количество заказов в день, шт.", alias="avgOrdersCountPerDay")
    conversions: Optional[NmReportGroupedResponseDataGroupsInnerStatisticsPreviousPeriodConversions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conversions": NmReportGroupedResponseDataGroupsInnerStatisticsPreviousPeriodConversions.from_dict(obj["conversions"]) if obj.get("conversions") is not None else None
        })
        return _obj
