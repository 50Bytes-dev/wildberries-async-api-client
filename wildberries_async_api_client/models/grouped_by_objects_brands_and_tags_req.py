...
class GroupedByObjectsBrandsAndTagsReq(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Идентификатор отчёта в UUID-формате. Генерируется продавцом самостоятельно")
    report_type: StrictStr = Field(description="Тип отчёта — `GROUPED_HISTORY_REPORT`", alias="reportType")
    ...
    params: Optional[GroupedByObjectsBrandsAndTagsReqParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": GroupedByObjectsBrandsAndTagsReqParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
