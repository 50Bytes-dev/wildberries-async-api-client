...
class BySelectedNmIDReq(BaseModel):
    ...
    report_type: StrictStr = Field(description="Тип отчёта — `DETAIL_HISTORY_REPORT`", alias="reportType")
    ...
    params: Optional[BySelectedNmIDReqParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": BySelectedNmIDReqParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
