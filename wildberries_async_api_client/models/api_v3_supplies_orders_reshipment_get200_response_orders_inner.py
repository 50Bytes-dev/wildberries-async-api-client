...
class ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner(BaseModel):
    ...
    """ # noqa: E501
    supply_id: Optional[Any] = Field(default=None, description="Идентификатор поставки", alias="supplyID")
    order_id: Optional[Any] = Field(default=None, description="Идентификатор сборочного задания", alias="orderID")
