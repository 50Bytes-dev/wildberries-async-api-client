...
class RequestWithIntervalInner(BaseModel):
    """
    RequestWithIntervalInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID кампании")
    interval: Optional[RequestWithIntervalInnerInterval] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "interval": RequestWithIntervalInnerInterval.from_dict(obj["interval"]) if obj.get("interval") is not None else None
        })
        return _obj
