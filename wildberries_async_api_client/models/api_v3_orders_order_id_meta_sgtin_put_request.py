...
class ApiV3OrdersOrderIdMetaSgtinPutRequest(BaseModel):
    ...
    """ # noqa: E501
    sgtins: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=24)]] = Field(default=None, description="Массив КиЗов. Допускается от 16 до 135 символов для кода одной маркировки.")
