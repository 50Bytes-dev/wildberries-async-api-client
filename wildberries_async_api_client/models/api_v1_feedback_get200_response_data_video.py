...
class ApiV1FeedbackGet200ResponseDataVideo(BaseModel):
    ...
    duration_sec: Optional[StrictInt] = Field(default=None, description="Общая продолжительность видео")
    __properties: ClassVar[List[str]] = ["previewImage", "link", "duration_sec"]
