...
class ApiV1FeedbacksProductsRatingNmidGet200Response(BaseModel):
    """
    ApiV1FeedbacksProductsRatingNmidGet200Response
    """ # noqa: E501
    data: Optional[ApiV1FeedbacksProductsRatingNmidGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ApiV1FeedbacksProductsRatingNmidGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
