...
class ApiV1FeedbacksProductsRatingGet200Response(BaseModel):
    """
    ApiV1FeedbacksProductsRatingGet200Response
    """ # noqa: E501
    data: Optional[ApiV1FeedbacksProductsRatingGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ApiV1FeedbacksProductsRatingGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
