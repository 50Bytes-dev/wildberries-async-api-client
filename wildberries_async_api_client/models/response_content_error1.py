...
class ResponseContentError1(BaseModel):
    ...
    additional_errors: Optional[ResponseContentError1AdditionalErrors] = Field(default=None, alias="additionalErrors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalErrors": ResponseContentError1AdditionalErrors.from_dict(obj["additionalErrors"]) if obj.get("additionalErrors") is not None else None
        })
        return _obj
