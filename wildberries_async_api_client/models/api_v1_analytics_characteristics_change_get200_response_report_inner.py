...
class ApiV1AnalyticsCharacteristicsChangeGet200ResponseReportInner(BaseModel):
    ...
    var_date: Optional[date] = Field(default=None, description="Дата изменения характеристик товара на складе", alias="date")
    ...
    new_shk_id: Optional[StrictInt] = Field(default=None, description="Новый штрихкод товара в Wildberries", alias="newShkID")
    ...
    old_shk_id: Optional[StrictInt] = Field(default=None, description="Старый штрихкод товара в Wildberries", alias="oldShkID")
