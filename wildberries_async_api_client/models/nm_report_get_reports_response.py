...
class NmReportGetReportsResponse(BaseModel):
    ...
    additional_errors: Optional[List[NmReportGetReportsResponseAdditionalErrorsInner]] = Field(default=None, alias="additionalErrors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalErrors": [NmReportGetReportsResponseAdditionalErrorsInner.from_dict(_item) for _item in obj["additionalErrors"]] if obj.get("additionalErrors") is not None else None
        })
        return _obj
