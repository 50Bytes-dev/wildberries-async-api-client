...
class NmReportGroupedResponseDataGroupsInner(BaseModel):
    """
    ...
    tags: Optional[List[NmReportDetailResponseDataCardsInnerTagsInner]] = None
    object: Optional[NmReportGroupedResponseDataGroupsInnerObject] = None
    statistics: Optional[NmReportGroupedResponseDataGroupsInnerStatistics] = None
    __properties: ClassVar[List[str]] = ["brandName", "tags", "object", "statistics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "object": NmReportGroupedResponseDataGroupsInnerObject.from_dict(obj["object"]) if obj.get("object") is not None else None,
            "statistics": NmReportGroupedResponseDataGroupsInnerStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None
        })
        return _obj
