...
class ContentV2CardsUploadPostRequestInnerVariantsInnerCharacteristicsInner(BaseModel):
    """
    ...
    value: Optional[Any] = Field(description="Значение характеристики. Тип значения зависит от типа характеристики")
