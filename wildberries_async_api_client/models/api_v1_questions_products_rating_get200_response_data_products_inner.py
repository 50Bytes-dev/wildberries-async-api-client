...
class ApiV1QuestionsProductsRatingGet200ResponseDataProductsInner(BaseModel):
    """
    ...
    questions_count: Optional[StrictStr] = Field(default=None, description="Количество вопросов", alias="questionsCount")
    __properties: ClassVar[List[str]] = ["nmId", "imtId", "productName", "brandName", "questionsCount"]
