...
class ApiV1SupplierValuationsGet200Response(BaseModel):
    """
    ApiV1SupplierValuationsGet200Response
    """ # noqa: E501
    data: Optional[ApiV1SupplierValuationsGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ApiV1SupplierValuationsGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
