...
class ContentV2CardsUploadPostRequestInnerVariantsInnerSizesInner(BaseModel):
    ...
    """ # noqa: E501
    tech_size: Optional[StrictStr] = Field(default=None, description="Размер товара (XL, 45 и др.)", alias="techSize")
    ...
    skus: Optional[List[StrictStr]] = Field(default=None, description="Баркод. Если не указать, сгенерируется системой автоматически.")
