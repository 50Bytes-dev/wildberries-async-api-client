...
class AdvV1SearchSetStrongPostRequest(BaseModel):
    """
    AdvV1SearchSetStrongPostRequest
    """ # noqa: E501
    strong: Optional[List[StrictStr]] = Field(default=None, description="Минус-фразы (макс. 1000 шт.)")
    __properties: ClassVar[List[str]] = ["strong"]
