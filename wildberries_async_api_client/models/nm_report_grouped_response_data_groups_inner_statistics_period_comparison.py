...
class NmReportGroupedResponseDataGroupsInnerStatisticsPeriodComparison(BaseModel):
    """
    ...
    conversions: Optional[NmReportGroupedResponseDataGroupsInnerStatisticsPeriodComparisonConversions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conversions": NmReportGroupedResponseDataGroupsInnerStatisticsPeriodComparisonConversions.from_dict(obj["conversions"]) if obj.get("conversions") is not None else None
        })
        return _obj
