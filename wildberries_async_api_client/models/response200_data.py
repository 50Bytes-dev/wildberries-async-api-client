...
class Response200Data(BaseModel):
    """
    Response200Data
    """ # noqa: E501
    templates: Optional[List[Response200DataTemplatesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "templates": [Response200DataTemplatesInner.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj
