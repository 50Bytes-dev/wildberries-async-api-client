...
class ContentV2CardsErrorListGet200Response(BaseModel):
    """
    ContentV2CardsErrorListGet200Response
    """ # noqa: E501
    data: Optional[List[ContentV2CardsErrorListGet200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ContentV2CardsErrorListGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "error": obj.get("error"),
