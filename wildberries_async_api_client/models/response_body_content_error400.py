...
class ResponseBodyContentError400(BaseModel):
    ...
    additional_errors: Optional[ResponseBodyContentError400AdditionalErrors] = Field(default=None, alias="additionalErrors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalErrors": ResponseBodyContentError400AdditionalErrors.from_dict(obj["additionalErrors"]) if obj.get("additionalErrors") is not None else None
        })
        return _obj
