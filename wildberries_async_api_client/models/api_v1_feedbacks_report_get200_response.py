...
class ApiV1FeedbacksReportGet200Response(BaseModel):
    """
    ApiV1FeedbacksReportGet200Response
    """ # noqa: E501
    data: Optional[ApiV1FeedbacksReportGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ApiV1FeedbacksReportGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
