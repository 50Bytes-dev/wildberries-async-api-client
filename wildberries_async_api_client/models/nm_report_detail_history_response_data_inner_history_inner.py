...
class NmReportDetailHistoryResponseDataInnerHistoryInner(BaseModel):
    """
    NmReportDetailHistoryResponseDataInnerHistoryInner
    """ # noqa: E501
    dt: Optional[date] = Field(default=None, description="Дата")
    ...
    add_to_cart_conversion: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Конверсия в корзину, % (Какой процент посетителей, открывших карточку товара, добавили товар в корзину)", alias="addToCartConversion")
