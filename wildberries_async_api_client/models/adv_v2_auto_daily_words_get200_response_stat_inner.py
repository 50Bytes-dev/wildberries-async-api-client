...
class AdvV2AutoDailyWordsGet200ResponseStatInner(BaseModel):
    """
    ...
    ctr: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Click-Through Rate, отношение количества кликов к количеству показов, %")
    sum: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Затраты, ₽")
    __properties: ClassVar[List[str]] = ["keyword", "views", "clicks", "ctr", "sum"]
