...
class ResponseErrorAdditionalErrorsInner(BaseModel):
    """
    ResponseErrorAdditionalErrorsInner
    """ # noqa: E501
    var_field: Optional[StrictStr] = Field(default=None, description="Структура, где допущена ошибка", alias="field")
