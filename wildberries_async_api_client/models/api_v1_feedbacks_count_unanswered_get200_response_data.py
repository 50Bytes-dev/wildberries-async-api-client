...
class ApiV1FeedbacksCountUnansweredGet200ResponseData(BaseModel):
    ...
    valuation: Optional[StrictStr] = Field(default=None, description="Средняя оценка всех отзывов")
    __properties: ClassVar[List[str]] = ["countUnanswered", "countUnansweredToday", "valuation"]
