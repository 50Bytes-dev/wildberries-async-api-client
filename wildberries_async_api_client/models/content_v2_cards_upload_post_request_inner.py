...
class ContentV2CardsUploadPostRequestInner(BaseModel):
    ...
    variants: List[ContentV2CardsUploadPostRequestInnerVariantsInner] = Field(description="Массив вариантов товара. В каждой КТ может быть не более 30 вариантов (НМ)")
