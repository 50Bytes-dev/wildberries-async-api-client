...
class ContentV2CardsUploadPostRequestInnerVariantsInner(BaseModel):
    ...
    sizes: Optional[List[ContentV2CardsUploadPostRequestInnerVariantsInnerSizesInner]] = Field(default=None, description="Массив с размерами. <br>  Если для размерного товара (обувь, одежда и др.) не указать этот массив, то системой в карточке он будет сгенерирован автоматически с `techSize` = \"A\" и `wbSize` = \"1\" и баркодом. ")
    characteristics: Optional[List[ContentV2CardsUploadPostRequestInnerVariantsInnerCharacteristicsInner]] = Field(default=None, description="Массив характеристик товара")
    __properties: ClassVar[List[str]] = ["brand", "title", "description", "vendorCode", "dimensions", "sizes", "characteristics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "characteristics": [ContentV2CardsUploadPostRequestInnerVariantsInnerCharacteristicsInner.from_dict(_item) for _item in obj["characteristics"]] if obj.get("characteristics") is not None else None
        })
        return _obj
