...
class NmReportDetailResponseDataCardsInnerStatisticsSelectedPeriod(BaseModel):
    """
    ...
    cancel_count: Optional[StrictInt] = Field(default=None, description="Отменили товаров, шт.", alias="cancelCount")
