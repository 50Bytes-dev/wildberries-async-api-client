...
class EventsResult(BaseModel):
    ...
    newest_event_time: Optional[StrictStr] = Field(default=None, description="Время новейшего события в ответе", alias="newestEventTime")
    oldest_event_time: Optional[StrictStr] = Field(default=None, description="Время старейшего события в ответе", alias="oldestEventTime")
