...
class ApiV1NewFeedbacksQuestionsGet200ResponseData(BaseModel):
    ...
    """ # noqa: E501
    has_new_questions: Optional[StrictBool] = Field(default=None, description="Есть ли непросмотренные вопросы (`true` есть, `false` нет)", alias="hasNewQuestions")
    has_new_feedbacks: Optional[StrictBool] = Field(default=None, description="Есть ли непросмотренные отзывы (`true` есть, `false` нет)", alias="hasNewFeedbacks")
