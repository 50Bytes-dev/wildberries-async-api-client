...
class TestApiV1FeedbackGet200Response(unittest.TestCase):
    """ApiV1FeedbackGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1FeedbackGet200Response:
        """Test ApiV1FeedbackGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1FeedbackGet200Response`
        """
        model = ApiV1FeedbackGet200Response()
        if include_optional:
            return ApiV1FeedbackGet200Response(
                data = wildberries_async_api_client.models._api_v1_feedback_get_200_response_data._api_v1_feedback_get_200_response_data(
                    id = 56, 
                    user_name = '', 
                    matching_size = '', 
                    text = '', 
    ...
    def testApiV1FeedbackGet200Response(self):
        """Test ApiV1FeedbackGet200Response"""
