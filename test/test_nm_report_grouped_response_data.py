...
class TestNmReportGroupedResponseData(unittest.TestCase):
    """NmReportGroupedResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NmReportGroupedResponseData:
        """Test NmReportGroupedResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NmReportGroupedResponseData`
        """
        model = NmReportGroupedResponseData()
        if include_optional:
            return NmReportGroupedResponseData(
                page = 1,
                is_next_page = True,
                groups = [
    ...
    def testNmReportGroupedResponseData(self):
        """Test NmReportGroupedResponseData"""
