...
class TestContentV2CardsUploadPostRequestInnerVariantsInner(unittest.TestCase):
    """ContentV2CardsUploadPostRequestInnerVariantsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentV2CardsUploadPostRequestInnerVariantsInner:
        """Test ContentV2CardsUploadPostRequestInnerVariantsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentV2CardsUploadPostRequestInnerVariantsInner`
        """
        model = ContentV2CardsUploadPostRequestInnerVariantsInner()
        if include_optional:
            return ContentV2CardsUploadPostRequestInnerVariantsInner(
                brand = '',
                title = '',
                description = '',
                vendor_code = '',
    ...
    def testContentV2CardsUploadPostRequestInnerVariantsInner(self):
        """Test ContentV2CardsUploadPostRequestInnerVariantsInner"""
