...
class TestStatsBlok2(unittest.TestCase):
    """StatsBlok2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatsBlok2:
        """Test StatsBlok2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatsBlok2`
        """
        model = StatsBlok2()
        if include_optional:
            return StatsBlok2(
