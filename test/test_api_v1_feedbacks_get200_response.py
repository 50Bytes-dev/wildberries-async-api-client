...
class TestApiV1FeedbacksGet200Response(unittest.TestCase):
    """ApiV1FeedbacksGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1FeedbacksGet200Response:
        """Test ApiV1FeedbacksGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1FeedbacksGet200Response`
        """
        model = ApiV1FeedbacksGet200Response()
        if include_optional:
            return ApiV1FeedbacksGet200Response(
                data = wildberries_async_api_client.models._api_v1_feedbacks_get_200_response_data._api_v1_feedbacks_get_200_response_data(
                    count_unanswered = 56, 
                    count_archive = 56, 
                    feedbacks = [
    ...
    def testApiV1FeedbacksGet200Response(self):
        """Test ApiV1FeedbacksGet200Response"""
