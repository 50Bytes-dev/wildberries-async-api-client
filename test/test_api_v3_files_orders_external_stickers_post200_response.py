    ...
    def make_instance(self, include_optional) -> ApiV3FilesOrdersExternalStickersPost200Response:
        ...
        if include_optional:
            return ApiV3FilesOrdersExternalStickersPost200Response(
                stickers = [
                    wb_client.models._api_v3_files_orders_external_stickers_post_200_response_stickers_inner._api_v3_files_orders_external_stickers_post_200_response_stickers_inner(
                        order_id = 5346346, 
