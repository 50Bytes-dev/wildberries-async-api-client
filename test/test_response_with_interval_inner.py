...
class TestResponseWithIntervalInner(unittest.TestCase):
    """ResponseWithIntervalInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseWithIntervalInner:
        """Test ResponseWithIntervalInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseWithIntervalInner`
        """
        model = ResponseWithIntervalInner()
        if include_optional:
            return ResponseWithIntervalInner(
    ...
    def testResponseWithIntervalInner(self):
        """Test ResponseWithIntervalInner"""
