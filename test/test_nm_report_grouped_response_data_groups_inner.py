...
class TestNmReportGroupedResponseDataGroupsInner(unittest.TestCase):
    """NmReportGroupedResponseDataGroupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NmReportGroupedResponseDataGroupsInner:
        """Test NmReportGroupedResponseDataGroupsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NmReportGroupedResponseDataGroupsInner`
        """
        model = NmReportGroupedResponseDataGroupsInner()
        if include_optional:
            return NmReportGroupedResponseDataGroupsInner(
                brand_name = 'Some',
                tags = [
    ...
    def testNmReportGroupedResponseDataGroupsInner(self):
        """Test NmReportGroupedResponseDataGroupsInner"""
