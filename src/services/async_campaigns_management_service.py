...
async def post_advv0cpm(data: Dict[str, Any], api_config_override: Optional[APIConfig] = None) -> None:
...
async def patch_advv0bids(data: Dict[str, Any], api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def post_advv0rename(data: Dict[str, Any], api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()

    base_path = api_config.base_path or "https://advert-api.wildberries.ru"
    path = f"/adv/v0/rename"
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": f"Bearer { api_config.get_access_token() }",
