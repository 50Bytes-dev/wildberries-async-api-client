...
class ApiV3SuppliesSupplyIdTrbxTrbxIdPatchRequest(BaseModel):
    """
    ApiV3SuppliesSupplyIdTrbxTrbxIdPatchRequest
    """ # noqa: E501
    order_ids: List[StrictInt] = Field(description="Список заказов, которые необходимо добавить в короб.", alias="orderIds")
