...
class ApiV3WarehousesWarehouseIdPutRequest(BaseModel):
    """
    ...
    office_id: Annotated[int, Field(strict=True, ge=1)] = Field(description="Идентификатор склада WB", alias="officeId")
